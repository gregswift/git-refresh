...
Comments say why. The code says what, and a comment should be as short as it can
be and still say what is necessary. [STYLE.md](STYLE.md) has the rules and the
failure cases behind them.
