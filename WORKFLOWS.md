...
This layout is Christopher Allen's, from [Git Worktree Best Practices and Tools](https://gist.github.com/ChristopherA/4643b2f5e024578606b9cd5d2e6815cc), along with the approach of implementing it as a handful of aliases and small scripts. `git clone-for-worktrees` is a descendant of the script in that gist, as are the `check-trees` and `prune-trees` aliases.
